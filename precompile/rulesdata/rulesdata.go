	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				...
				SyntaxPatterns: []ir.PatternString{
					...
					{Line: 160, Value: "if $*_, $err := $_; $err != nil { return $err }; return nil"},
					{Line: 161, Value: "$*_, $err = $_; if $err != nil { return $err }; return nil"},
					{Line: 162, Value: "var $*_, $err = $_; if $err != nil { return $err }; return nil"},
					{Line: 163, Value: "$*_, $err := $_; if $err != nil { return $err }; return nil"},
					{Line: 164, Value: "if $*_, $err = $_; $err != nil { return $err }; return $err"},
					{Line: 165, Value: "if $*_, $err := $_; $err != nil { return $err }; return $err"},
					{Line: 166, Value: "$*_, $err = $_; if $err != nil { return $err }; return $err"},
					{Line: 167, Value: "var $*_, $err = $_; if $err != nil { return $err }; return $err"},
					{Line: 168, Value: "$*_, $err := $_; if $err != nil { return $err }; return $err"},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 229,
				SyntaxPatterns: []ir.PatternString{
					{Line: 230, Value: "for $*_; $*_; $*_ { $*_; defer func($*args) $*_ { $*_ }($*_); $*_ }"},
					{Line: 231, Value: "for $*_; $*_; $*_ { $*_; defer $_($*args); $*_ }"},
					{Line: 233, Value: "for { $*_; defer func($*args) $*_ { $*_ }($*_); $*_ }"},
					{Line: 234, Value: "for { $*_; defer $_($*args); $*_ }"},
					{Line: 236, Value: "for $_, $_ := range $_ { $*_; defer func($*args) $*_ { $*_ }($*_); $*_ }"},
					{Line: 237, Value: "for $_, $_ := range $_ { $*_; defer $_($*args); $*_ }"},
					{Line: 239, Value: "for $_, $_ = range $_ { $*_; defer func($*args) $*_ { $*_ }($*_); $*_ }"},
					{Line: 240, Value: "for $_, $_ = range $_ { $*_; defer $_($*args); $*_ }"},
					{Line: 242, Value: "for $_ := range $_ { $*_; defer func($*args) $*_ { $*_ }($*_); $*_ }"},
					{Line: 243, Value: "for $_ := range $_ { $*_; defer $_($*args); $*_ }"},
					{Line: 245, Value: "for $_ = range $_ { $*_; defer func($*args) $*_ { $*_ }($*_); $*_ }"},
					{Line: 246, Value: "for $_ = range $_ { $*_; defer $_($*args); $*_ }"},
					{Line: 248, Value: "for range $_ { $*_; defer func($*args) $*_ { $*_ }($*_); $*_ }"},
					{Line: 249, Value: "for range $_ { $*_; defer $_($*args); $*_ }"},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 303,
				SyntaxPatterns: []ir.PatternString{
					{Line: 304, Value: "for $*_; $*_; $*_ { $*_; $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 305, Value: "for { $*_; $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 306, Value: "for $_, $_ := range $_ { $*_; $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 307, Value: "for $_, $_ = range $_ { $*_; $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 308, Value: "for $_ := range $_ { $*_; $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 309, Value: "for $_ = range $_ { $*_; $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 310, Value: "for range $_ { $*_; $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 312, Value: "for $*_; $*_; $*_ { $*_; $*_ := regexp.$method($s, $*args); $*_ }"},
					{Line: 313, Value: "for { $*_; $*_ := regexp.$method($s, $*args); $*_ }"},
					{Line: 314, Value: "for $_, $_ := range $_ { $*_; $*_ := regexp.$method($s, $*args); $*_ }"},
					{Line: 315, Value: "for $_, $_ = range $_ { $*_; $*_ := regexp.$method($s, $*args); $*_ }"},
					{Line: 316, Value: "for $_ := range $_ { $*_; $*_ := regexp.$method($s, $*args); $*_ }"},
					{Line: 317, Value: "for $_ = range $_ { $*_; $*_ := regexp.$method($s, $*args); $*_ }"},
					{Line: 318, Value: "for range $_ { $*_; $*_ := regexp.$method($s, $*args); $*_ }"},
					{Line: 320, Value: "for $*_; $*_; $*_ { $*_; var $*_ $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 321, Value: "for { $*_; var $*_ $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 322, Value: "for $_, $_ := range $_ { $*_; var $*_ $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 323, Value: "for $_, $_ = range $_ { $*_; var $*_ $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 324, Value: "for $_ := range $_ { $*_; var $*_ $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 325, Value: "for $_ = range $_ { $*_; var $*_ $*_ = regexp.$method($s, $*args); $*_ }"},
					{Line: 326, Value: "for range $_ { $*_; var $*_ $*_ = regexp.$method($s, $*args); $*_ }"},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 346,
				SyntaxPatterns: []ir.PatternString{
					{Line: 346, Value: "$res, $err := $_($*_); $*body"},
					{Line: 347, Value: "$res, $err = $_($*_); $*body"},
					{Line: 348, Value: "var $res, $err = $_($*_); $*body"},
				},
							...
							Args: []ir.FilterExpr{
								{
									...
									Args: []ir.FilterExpr{
											...
											Args: []ir.FilterExpr{
												{
													...
													Src:   "m[\"res\"].Type.Implements(`io.Closer`)",
													Value: "res",
													Args:  []ir.FilterExpr{{Line: 351, Op: ir.FilterStringOp, Src: "`io.Closer`", Value: "io.Closer"}},
												},
												{
													Line: 352,
													Op:   ir.FilterNotOp,
										...
										},
										{
											...
											Src:   "m[\"err\"].Type.Implements(`error`)",
											Value: "err",
											Args:  []ir.FilterExpr{{Line: 353, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
										},
									},
								},
								{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 374,
				SyntaxPatterns: []ir.PatternString{
					{Line: 374, Value: "$x := time.NewTimer($_); $*body"},
					{Line: 375, Value: "$x = time.NewTimer($_); $*body"},
					{Line: 376, Value: "var $x = time.NewTimer($_); $*body"},
					{Line: 377, Value: "var $x $_ = time.NewTimer($_); $*body"},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 396,
				SyntaxPatterns: []ir.PatternString{
					{Line: 396, Value: "$x := time.NewTicker($_); $*body"},
					{Line: 397, Value: "$x = time.NewTicker($_); $*body"},
					{Line: 398, Value: "var $x = time.NewTicker($_); $*body"},
					{Line: 399, Value: "var $x $_ = time.NewTicker($_); $*body"},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            410,
					SyntaxPatterns:  []ir.PatternString{{Line: 410, Value: "$err := $f($*args); if $err != nil { $*body }"}},
								...
								Args: []ir.FilterExpr{
									{
										...
										Src:   "m[\"err\"].Type.Implements(\"error\")",
										Value: "err",
										Args:  []ir.FilterExpr{{Line: 411, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
									},
									{
										Line:  412,
										Op:    ir.FilterVarTextMatchesOp,
										...
										Value: "f",
										Args:  []ir.FilterExpr{{Line: 412, Op: ir.FilterStringOp, Src: "\"(?s)^.{0,40}$\"", Value: "(?s)^.{0,40}$"}},
									},
								},
							},
							{
				...
				{
					Line:            422,
					SyntaxPatterns:  []ir.PatternString{{Line: 422, Value: "var $err = $f($*args); if $err != nil { $*body }"}},
					ReportTemplate:  "error check can be simplified in one line",
					SuggestTemplate: "if $err := $f($args); $err != nil { $body }",
					WhereExpr: ir.FilterExpr{
						Line: 423,
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           438,
				SyntaxPatterns: []ir.PatternString{{Line: 438, Value: "$x.Put($y)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 439, Op: ir.FilterStringOp, Src: "\"sync.Pool\"", Value: "sync.Pool"}},
						},
						{
							Line: 439,
							Op:   ir.FilterNotOp,
																...
																Args: []ir.FilterExpr{
																	{
																		...
																		Src:   "m[\"y\"].Type.Underlying().Is(\"*$_\")",
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 433, Op: ir.FilterStringOp, Src: "\"*$_\"", Value: "*$_"}},
																	},
																	{
																		Line:  439,
																		Op:    ir.FilterVarTypeUnderlyingIsOp,
																		...
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 433, Op: ir.FilterStringOp, Src: "\"chan $_\"", Value: "chan $_"}},
																	},
																},
															},
															{
																...
																Value: "y",
																Args:  []ir.FilterExpr{{Line: 434, Op: ir.FilterStringOp, Src: "\"map[$_]$_\"", Value: "map[$_]$_"}},
															},
														},
													},
													{
														...
														Value: "y",
														Args:  []ir.FilterExpr{{Line: 434, Op: ir.FilterStringOp, Src: "\"interface{$*_}\"", Value: "interface{$*_}"}},
													},
												},
											},
											{
												...
												Value: "y",
												Args:  []ir.FilterExpr{{Line: 435, Op: ir.FilterStringOp, Src: "`func($*_) $*_`", Value: "func($*_) $*_"}},
											},
										},
									},
									{
										...
										Value: "y",
										Args:  []ir.FilterExpr{{Line: 435, Op: ir.FilterStringOp, Src: "`unsafe.Pointer`", Value: "unsafe.Pointer"}},
									},
								},
							}},
						},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 447,
				SyntaxPatterns: []ir.PatternString{
					{Line: 447, Value: "const $x = $_; $*body"},
					{Line: 447, Value: "const $x $_ = $_; $*body"},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 461,
				SyntaxPatterns: []ir.PatternString{
					{Line: 462, Value: "var $x = $v; return $x"},
					{Line: 463, Value: "$x := $v; return $x"},
				},
														...
														Args: []ir.FilterExpr{
															{
																...
																Src:   "m[\"x\"].Type.Underlying().Is(\"*$_\")",
																Value: "x",
																Args:  []ir.FilterExpr{{Line: 456, Op: ir.FilterStringOp, Src: "\"*$_\"", Value: "*$_"}},
															},
															{
																Line:  465,
																Op:    ir.FilterVarTypeUnderlyingIsOp,
																...
																Value: "x",
																Args:  []ir.FilterExpr{{Line: 456, Op: ir.FilterStringOp, Src: "\"chan $_\"", Value: "chan $_"}},
															},
														},
													},
													{
														...
														Value: "x",
														Args:  []ir.FilterExpr{{Line: 457, Op: ir.FilterStringOp, Src: "\"map[$_]$_\"", Value: "map[$_]$_"}},
													},
												},
											},
											{
												...
												Src:   "m[\"x\"].Type.Underlying().Is(\"interface{$*_}\")",
												Value: "x",
												Args:  []ir.FilterExpr{{Line: 457, Op: ir.FilterStringOp, Src: "\"interface{$*_}\"", Value: "interface{$*_}"}},
											},
										},
									},
									{
										...
										Value: "x",
										Args:  []ir.FilterExpr{{Line: 458, Op: ir.FilterStringOp, Src: "`func($*_) $*_`", Value: "func($*_) $*_"}},
									},
								},
							},
							{
								...
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 458, Op: ir.FilterStringOp, Src: "`unsafe.Pointer`", Value: "unsafe.Pointer"}},
							},
						},
					}},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 483,
				SyntaxPatterns: []ir.PatternString{
					{Line: 484, Value: "if $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 485, Value: "if $err = $_($*_); $err2 != nil { $*_ }"},
					{Line: 486, Value: "if $*_, $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 487, Value: "if $*_, $err = $_($*_); $err2 != nil { $*_ }"},
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Src:   "m[\"err\"].Type.Implements(\"error\")",
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 488, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  488,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 489, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 489, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
